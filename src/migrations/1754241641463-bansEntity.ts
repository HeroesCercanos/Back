...
export class BansEntity1754241641463 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        // 0) Asegurarnos de la extensión uuid-ossp
        await queryRunner.query(`
            CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
        `);

        // 1) Si ya existiera un tipo llamado "ban", lo eliminamos
        await queryRunner.query(`
            DROP TYPE IF EXISTS "ban" CASCADE;
        `);

        // 2) Si ya existiera la tabla, la eliminamos
        await queryRunner.query(`
        ...
        // 4) Agregamos la FK de userId → user.id
        await queryRunner.query(`
            ALTER TABLE "ban"
            ADD CONSTRAINT "FK_42b00b47164747240a163318b7"
            FOREIGN KEY ("userId") REFERENCES "user"("id");
        `);

        // 5) Eliminamos las columnas antiguas de User
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "ban"
            DROP CONSTRAINT IF EXISTS "FK_42b00b47164747240a163318b7";
        `);
        ...
        // 3) Recreamos las columnas antiguas en User
        await queryRunner.query(`
            ALTER TABLE "user"
